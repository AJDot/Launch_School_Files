...
display_q(1)
# Question 1
# How will the ids change throughout this code?
# Answer 1
def fun_with_ids
  a_outer = 42
  b_outer = "forty two"
...
def fun_with_ids
  ...
  # This will be the same as before the method was called
...
def an_illustrative_method(a_outer, b_outer, c_outer, d_outer, a_outer_id, b_outer_id, c_outer_id, d_outer_id)
  ...
  c_outer_inner_id = c_outer.object_id
  d_outer_inner_id = d_outer.object_id
  # ids will stay the same but these "outers" are NOT the same variables as those outside the method
...
# This is true because += does not mutate but << does.
